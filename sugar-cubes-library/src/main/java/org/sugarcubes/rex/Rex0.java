 ...
 * @author Maxim Butov
 */
public class Rex0<T extends Throwable> {

    /**
     * Static factory-method for creating {@link Rex0} instance wrapping a {@link Throwable}.
     *
     * @param throwable the throwable happened
     * @return Rex wrapper
     */
    public static <T extends Throwable> Rex0<T> of(T throwable) {
        return new Rex0<>(throwable);
    }
     ...
     */
    public <E extends Throwable> Rex0<T> throwIf(Class<E> exceptionClass) throws E {
     ...
     */
    public Rex0<T> throwIf(Class<Throwable>... exceptionClasses) throws T {
     ...
     * @throws T original throwable
     */
    public Rex0<T> throwIf(Executable methodOrConstructor) throws T {
     ...
     */
    public Rex0<T> throwIfError() throws Error {
     ...
     */
    public Rex0<T> throwIfRuntime() throws RuntimeException {
     ...
     * @throws RuntimeException the original throwable casted to {@link RuntimeException}
     */
    public Rex0<T> throwIfUnchecked() throws Error, RuntimeException {
     ...
     */
    public Rex0<Throwable> cause() {
        Throwable cause = throwable.getCause();
        return cause != null ? new Rex0<>(cause) : null;
    }
     ...
     * @return same Rex instance
     */
    public <E extends Throwable> Rex0<E> cast() {
        return (Rex0) this;
    }
     ...
     */
    public <E extends Throwable> Rex0<Throwable> replaceWithCauseIf(Class<E> exceptionClass) {
     ...
     */
    public Rex0<T> submit(Consumer<T> consumer) {
    ...
    public <E extends Throwable> Rex0<T> ifThenThrow(Predicate<Throwable> predicate, Function<Throwable, E> function) throws E {
    ...
    public <X extends Throwable, Y extends Throwable> Rex0<T> ifThenThrow(Class<X> type, Function<X, Y> function) throws Y {
